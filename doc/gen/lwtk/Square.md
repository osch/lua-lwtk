...
## Constructor
   * <span id=".new">**`Square(initParams)`**</span>

        * Inherited from: **[Group()](../lwtk/Group.md#constructor)**


## Methods
   * <span id=".addChild">**`Square:addChild(child, index)`**</span>
   ...
   * <span id=".getMeasures">**`Square:getMeasures()`**</span>

        * Implements: [Component:getMeasures()](../lwtk/Component.md#.getMeasures)


   * <span id=".onLayout">**`Square:onLayout(w, h)`**</span>
