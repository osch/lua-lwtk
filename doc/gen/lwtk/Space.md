...
## Constructor
   * <span id=".new">**`Space(initParams)`**</span>

        * Inherited from: **[Group()](../lwtk/Group.md#constructor)**


## Methods
   * <span id=".addChild">**`Space:addChild(child, index)`**</span>
   ...
   * <span id=".getMeasures">**`Space:getMeasures()`**</span>

        * Implements: [Component:getMeasures()](../lwtk/Component.md#.getMeasures)


   * <span id=".onLayout">**`Space:onLayout(w, h)`**</span>

        * Implements: [Component:onLayout()](../lwtk/Component.md#.onLayout)


   * <span id=".setUnlimited">**`Space:setUnlimited(unlimited)`**</span>
