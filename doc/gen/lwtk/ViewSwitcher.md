...
## Constructor
   * <span id=".new">**`ViewSwitcher(initParams)`**</span>

        * Inherited from: **[Group()](../lwtk/Group.md#constructor)**


## Methods
   * <span id=".addChild">**`ViewSwitcher:addChild(child, index)`**</span>
   ...
   * <span id=".getMeasures">**`ViewSwitcher:getMeasures()`**</span>

        * Implements: [Component:getMeasures()](../lwtk/Component.md#.getMeasures)


   * <span id=".onLayout">**`ViewSwitcher:onLayout(w, h)`**</span>

        * Implements: [Component:onLayout()](../lwtk/Component.md#.onLayout)


   * <span id=".showChild">**`ViewSwitcher:showChild(child)`**</span>
